...
for m = 1:4
    ...
    ylimVals = ylim;
    text(1.05, ylimVals(2) - 0.05*diff(ylimVals), sprintf('p = %.3g (paired t-test)', p_val));
    box on; hold off;

    saveas(gcf, sprintf('/Users/rosenble/Desktop/GBM/Glioblastoma/Data/Figures/T-Test/T-Test_CST_%s.png', metrics{m}));
end
