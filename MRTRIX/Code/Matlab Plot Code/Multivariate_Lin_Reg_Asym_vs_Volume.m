%% Multivariate Linear Regression: Tumor Volume vs DTI Asymmetry Indices
clear;
...
mdl = fitlm(X_clean, y_clean, ...
    'VarNames', {'FA_Asym','MD_Asym','AD_Asym','RD_Asym','TumorVolume'});
...
writetable(coef_tbl, '/Users/rosenble/Desktop/GBM/Glioblastoma/Data/Tract_Overall_Stats_V2/Multivariate_Asym_vs_Volume.xlsx', ...
    'Sheet', 'Coefficients');
...
writetable(summary_tbl, '/Users/rosenble/Desktop/GBM/Glioblastoma/Data/Tract_Overall_Stats_V2/Multivariate_Asym_vs_Volume.xlsx', ...
    'Sheet', 'Model Summary');
