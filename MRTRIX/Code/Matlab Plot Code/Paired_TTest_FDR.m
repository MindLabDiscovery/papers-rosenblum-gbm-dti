% Independent T-Test FA, MD, AD, RD for ALL TRACTS with FDR correction (no normalization)
clear;
...
results = table(tracts', p_FA', p_FA_fdr', p_MD', p_MD_fdr', ...
    ...
    'p_AD','p_AD_FDR','p_RD','p_RD_FDR'});
writetable(results, '/Users/rosenble/Desktop/GBM/Glioblastoma/Data/Tract_Overall_Stats_V2/Independent_TTest_FDR_results.csv');
fprintf('Done.\n');
